...
class TestDABAssignmentSignals:
    ...
    def test_copy_dab_user_role_assignment_shared_team_role(
        ...
        from galaxy_ng.app.signals.handlers import copy_dab_user_role_assignment, SHARED_TEAM_ROLE
...
class TestM2MSignalHandlers:
    ...
    def test_copy_permission_role_to_rd(
        ...
        with pytest.raises(
            RuntimeError, match="Removal of permssions through reverse relationship"
        ):
            copy_permission_role_to_rd(
