...
class TestTeamMemberRoleSignalHandlers(TestCase):
    ...
    def test_copy_dab_user_role_assignment_team_member(self, mock_dab_signals, mock_signal_in_progress):
    ...
    @patch('galaxy_ng.app.signals.handlers.rbac_signal_in_progress')
    @patch('galaxy_ng.app.signals.handlers.dab_rbac_signals')
    def test_copy_dab_user_role_assignment_other_role(self, mock_dab_signals, mock_signal_in_progress):
    ...
    # def test_delete_dab_user_role_assignment_team_member(self, mock_assignment_model, mock_dab_signals, mock_signal_in_progress):
    #     """Test that Team Member role deletion removes user from group when no other assignments exist."""
    ...
    @patch('galaxy_ng.app.signals.handlers.dab_rbac_signals')
    @patch('galaxy_ng.app.signals.handlers.RoleUserAssignment')
    def test_delete_dab_user_role_assignment_with_other_assignments(self, mock_assignment_model, mock_dab_signals, mock_signal_in_progress):
    ...
    @patch('galaxy_ng.app.signals.handlers.rbac_signal_in_progress')
    @patch('galaxy_ng.app.signals.handlers.dab_rbac_signals')
    def test_delete_dab_user_role_assignment_no_content_object(self, mock_dab_signals, mock_signal_in_progress):
    ...
    @patch('galaxy_ng.app.signals.handlers.RoleUserAssignment')
    def test_copy_dab_group_to_role_simplified(self, mock_assignment_model, mock_role_def, mock_signal_in_progress):
